<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="books_database_employees.aspx.cs" Inherits="LibraryEnterprise.books_database_employees" %>
                    ...
                    <td>
                        <div id="search_books_container">
                            <table id="search_books_table">
                                <tr>
                                    <th colspan="2" class="title2">Search</th>
                                </tr>
                                <tr>
                                    <td>
