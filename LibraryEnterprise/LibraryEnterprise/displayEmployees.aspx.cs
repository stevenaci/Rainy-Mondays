/* File: displayEmployees.aspx
 * Author: Scott Ritchie
 * 
 * Purpose:
 * Web form allowing employees to search, insert, update and delete records in the employees table.
 * Uses Employee_keeper.cs to carry out CRUD operations.
 */
